...
const TravelStoryCard = ({
  ...
  return (
    <div
      className="cursor-pointer border border-slate-300 rounded-lg overflow-hidden shadow hover:shadow-lg transition relative"
      onClick={onClick}
    >
      ...
      >
        <FaHeart
          className={`icon-btn hover:text-red-500 ${isFavourite ? "text-red-500" : "text-white"}`}
        />
      </button>
